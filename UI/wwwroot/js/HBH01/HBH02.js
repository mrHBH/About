...
class HBH01 {
  ...
  constructor(reference) {
    this._Initialize();
    this.csharp=reference;
        console.log("I am alives ! ");
       ...
       // this.TutorialGuy = new entity.Entity();
        ...
        this.UI_Guy=new Ui_Guy.Ui_Guy({cli:this.CLI_Guy, csharp:this.csharp});
       // this._CsharpRefrence.invokeMethodAsync('registerUImanager');
