...
// const h = (async () => {
                 ...
                 if (this._input.released('c')) {
                  ...
                  if (this._input.released('f')) {
                    ...
                    if (this._input.released('b')) {
                      ...
                      if (this._input.down('h')) {
                        this._SimpleOrbitControls.dispose()
                        // zoom += 100;
                      //   this._oribitcontrolson=false;
                      //   this._BirdViewCAM.position.set(100, 200, 25);
                      //   this._BirdViewCAM.lookAt(new THREE.Vector3(0, 0, 0));
              
                      //  // this._BirdViewCAM = new THREE.PerspectiveCamera(fov, aspect, near, far);
                      //       //this._BirdViewCAM.position.set(0, 0, 25);
                      //       // this._SimpleOrbitControls._lookat(new THREE.Vector3(4, 50, 400))
                      //       // this._SimpleOrbitControls.camera.lookAt(new THREE.Vector3(4, 50, 400))
                     ...
                     // this._BirdViewCAM.lookAt(new THREE.Vector3(0, 0, 0));
                      ...
                      if (this._input.down('o')) {
                        // zoom += 100;
                        this._oribitcontrolson=true;
                        this._BirdViewCAM.position.set(100, 200, 25);
                        this._BirdViewCAM.lookAt(new THREE.Vector3(0, 0, 0));
   ...
   //   this._LoadUI();
      ...
      this._camera.position.set(25, 10, 25);
       ...
       this._BirdViewCAM = new THREE.PerspectiveCamera(fov, aspect, near, far);
       this._BirdViewCAM.position.set(25, 10, 25);
    //  this._camera.position.set(100,100,100);
     // this._BirdViewCAM.lookAt(new THREE.Vector3(50, 5000, 0));
...
// 
    ...
    _UpdateOrbitControls(timeElapsed) {
     ...
     // if (this.Attention === "Canvas") {
        ...
        if (this._input.down('page_up')) zoom += 100;
        else if (this._input.down('page_down')) zoom -= 100;
